        ...
        <div class="header-container">
          <img src="images/vakexpic.jpg" alt="" class="header-home" style="padding-bottom: 40px;">
            ...
            <h2><?php echo $db->Read('website_content', 'content', 'page_id = "3" AND id = "18"')[0]['content'];?></h2>
                ...
                <a href="?page=aanvraagformulier"><img src="images/driehoek.png" style="margin-right:10px;" width="10" class="driehoekje"><u><i><?php echo $db->Read('website_content', 'content', 'page_id = "3" AND id = "20"')[0]['content'];?></i></u></a>
